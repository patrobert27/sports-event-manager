...
import { Plus, X, Palette, Users } from "lucide-react";
  ...
  return (
    <div className="mt-4 bg-white rounded-3xl p-8 border border-primary/10 shadow-[0_20px_50px_rgba(79,168,245,0.12)] animate-in slide-in-from-top-6 fade-in duration-300">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-2xl font-bold text-dark tracking-tight">Nova modalitat esportiva</h3>
      </div>
      ...
      <form onSubmit={handleSubmit(submit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Color */}
              <div className="space-y-1.5">
                <label className="text-sm font-bold text-dark/70 ml-1">Color identificatiu</label>
