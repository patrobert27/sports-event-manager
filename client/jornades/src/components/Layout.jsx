...
export default function Layout() {
  ...
  // Activar sistema de comunicados en tiempo real
  useAnnouncements();
  
  return (
    <div className="min-h-screen bg-background bg-gradient-to-br from-background to-white flex">
      ...
      <div className="flex-1 min-h-screen flex flex-col w-full max-w-full overflow-x-hidden">
        ...
        <main className="flex-1 px-4 py-8 w-full max-w-7xl mx-auto animate-fade-in overflow-x-hidden">
          <Outlet />
        </main>
